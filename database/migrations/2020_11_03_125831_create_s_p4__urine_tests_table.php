...
class CreateSP4UrineTestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP4_UrineTest', function (Blueprint $table) {
            $table->increments('SP4_UrineTest_ID');
    ...
    {
        Schema::dropIfExists('s_p4__urine_tests');
    }
}
