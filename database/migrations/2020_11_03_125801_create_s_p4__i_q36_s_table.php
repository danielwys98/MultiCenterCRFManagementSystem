...
class CreateSP4IQ36STable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP4_IQ36s', function (Blueprint $table) {
            $table->increments('SP4_IQ36_ID');
    ...
    {
        Schema::dropIfExists('s_p4__i_q36_s');
    }
}
