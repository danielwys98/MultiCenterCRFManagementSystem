...
class CreateSP2BMVSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP2_BMVS', function (Blueprint $table) {
            $table->increments('SP2_BMVS_ID');
    ...
    {
        Schema::dropIfExists('s_p2__b_m_v_s');
    }
}
