...
class CreateSP3PKineticSamplingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP3_PKineticSamplings', function (Blueprint $table) {
            $table->increments('SP3_PKineticSampling_ID');
    ...
    {
        Schema::dropIfExists('s_p3__p_kinetic_samplings');
    }
}
