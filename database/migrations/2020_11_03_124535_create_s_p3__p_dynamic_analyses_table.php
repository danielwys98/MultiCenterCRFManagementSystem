...
class CreateSP3PDynamicAnalysesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP3_PDynamicAnalysis', function (Blueprint $table) {
            $table->increments('SP3_PDynamicAnalysis_ID');
    ...
    {
        Schema::dropIfExists('s_p3__p_dynamic_analyses');
    }
}
