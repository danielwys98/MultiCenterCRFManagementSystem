...
class CreateSP2IQ48STable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP2_IQ48s', function (Blueprint $table) {
            $table->increments('SP2_IQ48_ID');
    ...
    {
        Schema::dropIfExists('s_p2__i_q48_s');
    }
}
