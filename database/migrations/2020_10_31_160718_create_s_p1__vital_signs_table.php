...
class CreateSP1VitalSignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP1_VitalSigns', function (Blueprint $table) {
            $table->increments('SP1_VitalSign_ID');
    ...
    {
        Schema::dropIfExists('s_p1__vital_signs');
    }
}
