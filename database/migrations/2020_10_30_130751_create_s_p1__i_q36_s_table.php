...
class CreateSP1IQ36STable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP1_IQ36s', function (Blueprint $table) {
            $table->increments('SP1_IQ36_ID');
    ...
    {
        Schema::dropIfExists('s_p1__i_q36_s');
    }
}
