...
class CreateSP1PDynamicSamplingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP1_PDynamicSamplings', function (Blueprint $table) {
            $table->increments('SP1_PDynamicSampling_ID');
    ...
    {
        Schema::dropIfExists('SP1_PDynamicSampling');
    }
}
