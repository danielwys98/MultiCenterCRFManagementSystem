...
class CreateSP4PDynamicAnalysesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP4_PDynamicAnalysis', function (Blueprint $table) {
            $table->increments('SP4_PDynamicAnalysis_ID');
    ...
    {
        Schema::dropIfExists('s_p4__p_dynamic_analyses');
    }
}
