...
class CreateSP4AQuestionnairesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sp4_AQuestionnaires', function (Blueprint $table) {
            $table->increments('SP4_AQuestionnaire_ID');
    ...
    {
        Schema::dropIfExists('s_p4__a_questionnaires');
    }
}
