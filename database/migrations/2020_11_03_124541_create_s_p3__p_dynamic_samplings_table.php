...
class CreateSP3PDynamicSamplingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP3_PDynamicSamplings', function (Blueprint $table) {
            $table->increments('SP3_PDynamicSampling_ID');
    ...
    {
        Schema::dropIfExists('s_p3__p_dynamic_samplings');
    }
}
