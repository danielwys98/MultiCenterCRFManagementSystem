...
class CreateSP4VitalSignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SP4_VitalSigns', function (Blueprint $table) {
            $table->increments('SP4_VitalSign_ID');
    ...
    {
        Schema::dropIfExists('s_p4__vital_signs');
    }
}
