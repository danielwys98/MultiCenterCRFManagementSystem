...
class CreateSP3AQuestionnairesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sp3_AQuestionnaires', function (Blueprint $table) {
            $table->increments('SP3_AQuestionnaire_ID');
    ...
    {
        Schema::dropIfExists('s_p3__a_questionnaires');
    }
}
