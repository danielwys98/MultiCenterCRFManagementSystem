...
<div class="row">
    <div class="col-md-5">
        <p>If “Yes”, specify amount and time taken{!! Form::text('Interim36hrs04txt',(old('interim36hrs04',$IQ36->interim36hrs04)!='No' && ($IQ36->interim36hrs04!=NULL))? 'checked' :'',['class'=>'form-control']) !!}</p>
    </div>
</div>
<hr>
{{-- Interim Question 5 --}}
