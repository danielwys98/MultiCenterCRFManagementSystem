{!! Form::model($IQ36,['route' => ['sp_IQuestionnaire36.update',$patient->id,$study_id,$study_period]]) !!}
@method('PUT')
@csrf
...
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim36hrs03', 'Yes',(old('Interim36hrs03',$IQ36->nterim36hrs03)!='No' && ($IQ36->interim36hrs03!=NULL))? 'checked' : '') !!}</p>
    </div>
    <div class="col-md-1">
        <p>{!! Form::radio('Interim36hrs03', 'No',(old('Interim36hrs03',$IQ36->interim36hrs03)=='No' && ($IQ36->interim36hrs03!=NULL))? 'checked' :'') !!}</p>
    </div>
</div>
<div class="row col">
...
<div class="row">
    <div class="col-md-5">
        {!! Form::text('Interim36hrs03txt',(old('Interim36hrs03', $IQ36->interim36hrs03)!='No')? $IQ36->interim36hrs03 : '',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 4 --}}
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim36hrs04', 'No',(old('interim36hrs04',$IQ36->interim36hrs04)=='No' && ($IQ36->interim36hrs04!=NULL))? 'checked' :'') !!}</p>
    </div>
</div>
<div class="row col">
...
<div class="row">
    <div class="col-md-5">
        <p>If “Yes”, specify amount and time taken{!! Form::text('Interim36hrs04txt',(old('interim36hrs04',$IQ36->interim36hrs04)!='No')? $IQ36->interim36hrs04 :'',['class'=>'form-control']) !!}</p>
    </div>
</div>
<hr>
{{-- Interim Question 5 --}}
<div class="row">
    ...
    <div class="col-md-1">
        {!! Form::radio('Interim36hrs05', 'No',(old('interim36hrs05',$IQ36->interim36hrs05)=='No' && ($IQ36->interim36hrs05!=NULL))? 'checked' :'') !!}
    </div>
</div>
<div class="row">
    <div class="col-md-5">
...
<div class="row">
    <div class="col-md-5">
        {!! Form::text('Interim36hrs05txt',(old('interim36hrs05',$IQ36->interim36hrs05)!='No')? $IQ36->interim36hrs05 :'',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 6 --}}
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim36hrs06', 'No',(old('interim36hrs06',$IQ36->interim36hrs06)=='No' && ($IQ36->interim36hrs06!=NULL))? 'checked' :'') !!}</p>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="row">
    <div class="col-md-5">
        {!! Form::text('Interim36hrs06txt',(old('interim36hrs06',$IQ36->interim36hrs06)!='No')? $IQ36->interim36hrs06 :'',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 7 --}}
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim36hrs07', 'No',(old('interim36hrs07',$IQ36->interim36hrs07)=='No' && ($IQ36->interim36hrs07!=NULL))? 'checked' :'') !!}</p>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="row">
    <div class="col-md-5">
        {!! Form::text('Interim36hrs07txt',(old('interim36hrs07',$IQ36->interim36hrs07)!='No')? $IQ36->interim36hrs07 :'',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 8 --}}
