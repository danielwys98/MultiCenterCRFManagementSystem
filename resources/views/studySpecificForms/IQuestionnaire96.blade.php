{!! Form::open(['route' => ['sp_IQuestionnaire96.store',$study->study_id]]) !!}
@csrf
...
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs01', 'Yes') !!}</p>
    </div>
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs01', 'No') !!}</p>
    </div>
</div>
<div class="row col">
...
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs02', 'Yes') !!}</p>
    </div>
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs02', 'No') !!}</p>
    </div>
</div>
<div class="row col">
...
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs03', 'Yes') !!}</p>
    </div>
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs03', 'No') !!}</p>
    </div>
</div>
<div class="row col">
...
<div class="row">
    <div class="col-md-5">
    {!! Form::text('Interim96hrs03txt', '',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 4 --}}
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs04', 'Yes') !!}</p>
    </div>
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs04', 'No') !!}</p>
    </div>
</div>
<div class="row col">
...
<div class="row">
    <div class="col-md-5">
        <p>If “Yes”, specify amount and time taken{!! Form::text('Interim96hrs04txt', '',['class'=>'form-control']) !!}</p>
    </div>
</div>
<hr>
{{-- Interim Question 5 --}}
<div class="row">
    ...
    <div class="col-md-1">
        {!! Form::radio('Interim96hrs05', 'Yes') !!}
    </div>
    <div class="col-md-1">
        {!! Form::radio('Interim96hrs05', 'No') !!}
    </div>
</div>
<div class="row">
    <div class="col-md-5">
...
<div class="row">
    <div class="col-md-5">
        {!! Form::text('Interim96hrs05txt', '',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 6 --}}
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs06', 'Yes') !!}</p>
    </div>
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs06', 'No') !!}</p>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="row">
    <div class="col-md-5">
       {!! Form::text('Interim96hrs06txt', '',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 7 --}}
<div class="row">
    ...
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs07', 'Yes') !!}</p>
    </div>
    <div class="col-md-1">
        <p>{!! Form::radio('Interim96hrs07', 'No') !!}</p>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
...
<div class="row">
    <div class="col-md-5">
        {!! Form::text('Interim96hrs07txt', '',['class'=>'form-control']) !!}
    </div>
</div>
<hr>
{{-- Interim Question 8 --}}
<div class="row">
    ...
    <div class="col-md-1">
        {!! Form::radio('Interim96hrs08', 'Yes') !!}
    </div>
    <div class="col-md-1">
        {!! Form::radio('Interim96hrs08', 'No') !!}
    </div>
    <div class="col-md-2">
        {!! Form::radio('Interim96hrs08', 'Not Applicable','',['id'=>'NA']) !!}
...
<div class="form-group row">
    <div class="offset-5 col-md-3">
        ...
        {!! Form::text('Interim96hrsInterviewedby', '',['class'=>'form-control']) !!}
    </div>
    <div class="col-md-3">
        {!! Form::label('Interim96hrsCheckedby', 'Checked by (initial): ') !!}
        {!! Form::text('Interim96hrsCheckedby', '',['class'=>'form-control']) !!}
    </div>
</div>
