    ...
    <div class="container-fluid">
        ...
        <div class="tab-content">
            ...
            <div id="BATER" class="tab-pane fade">
                @include('preScreeningForms.createForms.bater')
            </div>

            <div id="MHistory" class="tab-pane fade">
                @include('preScreeningForms.createForms.mHistory')
            </div>

            <div id="PExam" class="tab-pane fade">
                @include('preScreeningForms.createForms.pe')
            </div>

            <div id="UrineTest" class="tab-pane fade">
                @include('preScreeningForms.createForms.urineTest')
            </div>

            <div id="LabTest" class="tab-pane fade">
                @include('preScreeningForms.createForms.labTest')
            </div>

            <div id="STest" class="tab-pane fade">
                @include('preScreeningForms.createForms.sTest')
            </div>

            <div id="Criteria" class="tab-pane fade">
                @include('preScreeningForms.createForms.critieria')
            </div>

            <div id="Conclude" class="tab-pane fade">
                @include('preScreeningForms.createForms.conclusion')
            </div>
