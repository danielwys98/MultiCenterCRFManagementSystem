...
@section('content')
    {!! Form::model($followUpQ,['route'=>['updateFollowUpQ',$PID,$study_id,$patient]]) !!}
    <div class="row">
        <div class="col-md-9">
    ...
    <div class="row">
        <div class="col-sm-6">
            <p>7. Has the subject participated in other experimental drug studies or blood donation since last
                review?</p>
        </div>
        <div class="col-md-1">
