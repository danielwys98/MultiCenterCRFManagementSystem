            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{route('studySpecific.destroy',$study->study_id)}}" method="POST">
                        @csrf
                        {{method_field('DELETE')}}
                        <button type="submit" onclick="return confirm('Are you sure to delete this study?')" class="btn btn-outline-danger col-md-4"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
