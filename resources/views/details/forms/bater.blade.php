{!! Form::model($BATER,['route' => ['update.bater',$patient->id]]) !!}
    ...
    <h3>Breath Alcohol Test</h3>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-1">
                {!! Form::radio('Laboratory', 'Sarawak General Hospital Heart Centre',(old('laboratory',$BATER->laboratory)=='Sarawak General Hospital Heart Centre')? 'checked' : '') !!}
                {!! Form::label('Laboratory','Sarawak General Hospital Heart Centre') !!}
            </div>
            <div class="col-md-5">
                <div class="row">
                    <div class="col-md-2">
                        {!! Form::radio('Laboratory','Others',(old('laboratory',$BATER->laboratory)!=='Sarawak General Hospital Heart Centre')? 'checked' :'') !!}
                        {!! Form::label('Laboratory', 'Others') !!}
                    </div>
                    <div class="col-md-3">
                        {!! Form::text('Laboratory_text', (old('laboratory',$BATER->laboratory)!='Sarawak General Hospital Heart Centre')? $BATER->laboratory : '',['class'=>'form-control','placeholder'=>'Please specify']) !!}
                    </div>
                </div>
            </div>
        </div>
