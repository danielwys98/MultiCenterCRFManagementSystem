...
class SP_UrineTest_Controller extends Controller
{
    ...
    public function storeSP($findPSS,$PSS,$UT,$request){
        ...
        $custom = [
            ...
            'inclusionYesNo.required_if' => 'Please select whether the subject fulfill all the inclusion criteria and none of the exclusion criteria',
            'subjectFit.required_if' => 'Please select whether the subject is fit for dosing',
            'physicianSign.required_if' => 'Physician’s signature is required',
            'physicianName.required_if' => 'Physician’s name is required',
           ];
        if($findPSS !=NULL && $PSS != NULL){
            //validation for required fields
            $validatedData=$this->validate($request,[
                'uPreg_Laboratory' => 'required_if:UPreg_male,==, || required_if:AbsentUPreg,==, ',
                'uPreg_Laboratory_Text' => 'required_if:uPreg_Laboratory,==,Other',
                'uDrug_Laboratory' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'uDrug_Laboratory_Text' => 'required_if:uDrug_Laboratory,==,Other',
                'UPreg_dateTaken' => 'required_if:UPreg_male,==, || required_if:AbsentUPreg,==, ',
                'UPreg_TestTime' => 'required_if:UPreg_male,==, || required_if:AbsentUPreg,==, ',
                'UPreg_ReadTime' => 'required_if:UPreg_male,==, || required_if:AbsentUPreg,==, ',
                'UPreg_hCG' => 'required_if:UPreg_male,==, || required_if:AbsentUPreg,==, ',
                'UPreg_Transcribedby' => 'required_if:UPreg_male,==, || required_if:AbsentUPreg,==, ',
                'UDrug_dateTaken' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'UDrug_TestTime' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'UDrug_ReadTime' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'UDrug_Methamphetamine' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'UDrug_Morphine' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'UDrug_Marijuana' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'UDrug_Transcribedby' => 'required_if:NApplicable,==, || required_if:AbsentUDrug,==, ',
                'inclusionYesNo' => 'required_if:AbsentC,==,',
                'subjectFit' => 'required_if:AbsentC,==,',
                'physicianSign' => 'required_if:AbsentC,==,',
                'physicianName' => 'required_if:AbsentC,==,',
            ],$custom);
