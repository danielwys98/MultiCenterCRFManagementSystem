    ...
    public function store(Request $request,$study_id)
    {
        ...
        if($findPSS !=NULL){
           ...
           $validatedData=$this->validate($request,[
            ...
            'Interim48hrs03txt' => 'required_if:Interim48hrs03,==,Others',
            'Interim48hrs04' => 'required',
            'Interim48hrs04txt' => 'required_if:Interim48hrs04,==,Others',
            'Interim48hrs05' => 'required',
            'Interim48hrs05txt' => 'required_if:Interim48hrs05,==,Others',
            'Interim48hrs06' => 'required',
            'Interim48hrs06txt' => 'required_if:Interim48hrs06,==,Others',
            'Interim48hrs07' => 'required',
            'Interim48hrs07txt' => 'required_if:Interim48hrs07,==,Others',
