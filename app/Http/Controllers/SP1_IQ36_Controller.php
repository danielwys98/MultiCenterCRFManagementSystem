    ...
    public function store(Request $request,$study_id)
    {
        ...
        if($findPSS !=NULL){
           ...
           $validatedData=$this->validate($request,[
            ...
            'Interim36hrs03txt' => 'required_if:Interim36hrs03,==,Others',
            'Interim36hrs04' => 'required',
            'Interim36hrs04txt' => 'required_if:Interim36hrs04,==,Others',
            'Interim36hrs05' => 'required',
            'Interim36hrs05txt' => 'required_if:Interim36hrs05,==,Others',
            'Interim36hrs06' => 'required',
            'Interim36hrs06txt' => 'required_if:Interim36hrs06,==,Others',
            'Interim36hrs07' => 'required',
            'Interim36hrs07txt' => 'required_if:Interim36hrs07,==,Others',
